        ...
        <div className="">
            ...
            <div className={`absolute w-full pt-5 pb-8 leading-9 text-center bg-color-four shadow-md ${isOpen?'top-16':'-top-64'} text-color-one transition-all ease-in-out duration-500 z-10`}>
                <ul>
                    ...
                    <li><a href="#portofolio" className='text-xl font-bold transition-all hover:text-color-two'>Portofolio</a></li>
                    <li><a href="#contact" className='text-xl font-bold transition-all hover:text-color-two'>Contact</a></li>
                </ul>
            </div>
        </div>
     );
