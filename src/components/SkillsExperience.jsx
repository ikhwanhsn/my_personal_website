    ...
    return ( 
        <div className="">
            ...
            <dialog id={`my_modal_${modal}`} className="modal">
                <form method="dialog" className="shadow-md modal-box bg-color-four dark:bg-color-one">
                    <button className="absolute font-bold shadow-sm btn btn-sm btn-circle btn-ghost right-2 top-2 text-color-one bg-color-four dark:bg-color-one dark:text-color-four">✕</button>
                    {/* <img src={src} alt="porto" className='rounded-md'/> */}
                    ...
                    <h3 className="mt-3 text-lg font-bold text-color-one">{title}</h3>
                    <p className='text-sm'>Date : {date}</p>
                    <h5 className='mt-2 font-bold'>Learning path :</h5>
