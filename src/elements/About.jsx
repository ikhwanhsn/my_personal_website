...
const About = () => {
    return ( 
        <div className={`w-full h-full transition-all duration-500 ease-in-out lg:flex lg:flex-row-reverse lg:h-screen lg:items-center lg:dark:bg-color-one lg:bg-color-four lg:gap-64`}>
