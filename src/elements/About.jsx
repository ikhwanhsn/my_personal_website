    ...
    return ( 
        <div className="w-full h-full">
            ...
            <div className="mt-5 text-center text-color-one">
                ...
                <button className='px-5 py-2 mt-6 border-2 rounded-full shadow-md trasition-all border-color-one hover:bg-color-one hover:text-color-four shadow-[rgba(0,0,0,.2)]'><a href="#skills">See more</a></button>
            </div>
        </div>
     );
}
