...
const Skills = () => {
    return ( 
        <div className="pt-24 text-center transition-all duration-500 ease-in-out dark:bg-color-one dark:text-color-four bg-color-four text-color-one lg:flex lg:justify-between lg:px-24 lg:h-screen lg:items-center lg:pt-0" id='skills'>
            <div className="transition-all duration-500 ease-in-out mx-7 dark:bg-color-one dark:text-color-four bg-color-four text-color-one lg:text-left">
                ...
                <div className="grid lg:text-center grid-cols-4 px-5 mt-8 border-4 rounded-md shadow-md gap-x-5 lg:gap-x-12 gap-y-12 py-9 transition-all ease-in-out duration-500 dark:bg-color-one dark:text-color-four bg-color-four text-color-one shadow-[rgba(0,0,0,.2)] dark:shadow-[rgba(255,255,255,0.04)]">
            ...
            <div className="lg:pt-12">
                <div className="px-7">
                    ...
                    <ol className='mt-2 leading-8 text-left lg:leading-7 '>
                ...
                <div className="px-7">
                    ...
                    <ul className='mt-2 leading-8 text-left lg:leading-7 '>
